...
public class SwaggerConfig {
	...
	public Docket getDocket() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.mjv.projeto"))
				.build()
				.apiInfo(apiInfo())
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder()
				.title("SISTEMA DE VENDAS MJV - PROJETO FINAL")
				.description("API RESTFul utilizando Springboot e Banco de Dados em memória")
				.version("1.0.0")
